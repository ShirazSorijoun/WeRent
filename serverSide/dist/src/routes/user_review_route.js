...
router.delete('/admin/:id', auth_middleware_1.default, user_review_controller_1.default.adminDeleteReview);
router.delete('/:id', auth_middleware_1.default, user_review_controller_1.default.deleteReview);
