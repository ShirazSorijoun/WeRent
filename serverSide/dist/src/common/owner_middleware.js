...
const ownerMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user.roles === user_model_1.UserRole.Owner) {
        next();
    }
    else {
...
exports.default = ownerMiddleware;
//# sourceMappingURL=owner_middleware.js.map